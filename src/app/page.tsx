      ...
      <div className="relative">
        ...
        <header className="max-w-7xl mx-auto px-4 py-6">
          <nav className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-emerald-400">GE</h1>
              ...
              {user ? (
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative z-50">
                    ...
                    >
                      <LuCircleUserRound className="w-5 h-5 text-emerald-400" />
                      <BiChevronDown className="w-4 h-4 text-zinc-400" />
                    </button>

                    {isMenuOpen && (
                      <div className="absolute right-0 mt-2 w-48 bg-zinc-800 rounded-md shadow-xl border border-zinc-700">
                        <button
